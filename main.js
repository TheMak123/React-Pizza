const documentMainPage = {
    ...
    select_pizza: document.querySelector(".select-pizza"),
        ...
        <div class="pizza_item">
             ...
             <div class="pizza_choice">
                 <button class="pizza_choice_btn ${
                     pizzas[i].type[0].isActive ? "choise_btn_active" : ""
                    }" onClick='changeTypePizza(${pizzas[i].type[0].id}", "${
            pizzas[i].id
        }")'>тонкое</button>
                     <button class="pizza_choise_btn ${
                        pizzas[i].type[1].isActive ? "choise_btn_active" : ""
            ...
            pizzas[i].id
              ...
              <div class="pizza_buy">
                    ...
                    <button class="pizza_btn_buy" onClick='buyPizza("${idType}", "${price}")'>
                            <svg
                            xmlns="https://www.w3.org/2000/swg"
                            width="12"
                            height="12"
                            vievBox="0 0 12 12"
                            fill="none"
                            >
                            <path
                                    d="M10.8 4.8.H7.2V1.2C7.2 0.5373 6.6627 0 6 0C5.3373 0 4.8 0.5373 4.8 1.2V4.8H1.2C0.5373 4.8 0 5.3373 0 6C0 6.6627 0.5373 7.2 1.2 7.2H4.8V10.8C4.8 11.4627 5.3373 12 6 12C6.6627 12 7.2 11.4627 7.2 10.8V7.2H10.8C11.2627 7.2 12 6.6627 12 6C12 5.3
                                    fill="#EB5A1E"
                            />
                            </svg>
                            Добавить
