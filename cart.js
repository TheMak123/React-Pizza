            ...
            <div class="cart_item">
              <div class="cart_wrapper">
                   <div class="item_info">
                       ...
                       <div class="item_info_discription">
                           <h1>${result.name}</h1>
                    ...
                    <div class="cart_wrapper">
                            <h1 class="item_price">${result.price * obj[key]} Р</h1>
...
function calcPizzaInCart(id, opetator) {
    const pizzaCookie = document.cookie.split("; ");
    let isCookie = false;
...
documentCartPage.trash_text.addEventListener("click", function () {
    ...
    documentCartPage.emptyPage.classList.add("none");
});
